...
const en = {
  ...
  deptNames: {
    ...
    ambulance: 'Medical & Ambulance Services',
    police: 'Police Department',
    municipal: 'Municipal Corporation & Public Works',
    electricity: 'State Electricity Board',
    water: 'Water Supply & Sewerage Board',
    animal: 'Animal Welfare & Veterinary Services',
  },
  deptShort: {
    fire: 'Fire Services',
    ambulance: 'Medical / 108',
    police: 'Police',
    municipal: 'Municipal / PWD',
  ...
  issueDetail: {
    ...
    aiTranslated: 'AI translation — may be imperfect',
    translateFailed: 'Could not translate right now.',
    location: 'Location',
  ...
  dashboard: {
    ...
    filterBreaching: 'SLA overdue',
    selectedCount: '{{count}} selected',
    bulkAcknowledge: 'Acknowledge',
    bulkResolve: 'Mark done',
    clearSelection: 'Clear',
    bulkUpdated: '{{count}} issues updated',
    emergency: 'Emergency',
  ...
  analytics: {
    ...
    kpiCsat: 'Citizen satisfaction',
    thCsat: 'Satisfaction',
    csatSuffix: '{{avg}}/5 ({{count}} rated)',
    csatNone: 'No ratings yet',
  ...
  transparency: {
    ...
    mostSupported: 'Most-supported open issues',
    leaderboard: 'Department resolution leaderboard',
    leaderboardHint: 'Ranked by resolution rate across public reports.',
    thDepartment: 'Department',
    thResolved: 'Resolved',
    thTotal: 'Total',
    thRate: 'Rate',
    thAvgTime: 'Avg time',
    openData: 'Open data',
    openDataHint: 'Download the anonymised public dataset — no personal information.',
  ...
  admin: {
    ...
    qrTitle: 'QR posters',
    qrHint:
      'Print and post at offices, bus stops and notice boards — scanning opens the report wizard with the category pre-filled. Composed on your device; nothing is uploaded.',
    qrGeneralHeading: 'Report a civic issue',
    qrScanToReport: 'Scan to report — it takes under a minute',
    qrDownload: 'Download poster (PNG)',
    qrFailed: 'Could not generate the poster.',
    tileTotal: 'Total',
    tileOpen: 'Open',
